...
public record MarkerPacket(BlockPos pos) implements CustomPayload {
    public static final Id<MarkerPacket> ID = new Id<>(Identifier.of(WorldbreakerProtocol.MOD_ID, "marker_packet"));
