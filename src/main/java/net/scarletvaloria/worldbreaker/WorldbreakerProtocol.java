...
public class WorldbreakerProtocol implements ModInitializer {
    ...
    public static final SerializableDataTicket<Double> CHARGE_LEVEL = GeckoLibUtil.addDataTicket(SerializableDataTicket.ofDouble(id("charge_level")));
    ...
    public void onInitialize() {
        ...
        ServerTickEvents.END_SERVER_TICK.register(server -> {
            for (ServerPlayerEntity player : server.getPlayerManager().getPlayerList()) {
                ...
                if (!DIVING_PLAYERS.contains(uuid)) continue;
