...
public class TomahawkItem extends SwordItem {
    ...
    public static AttributeModifiersComponent createAttributeModifiers() {
        return AttributeModifiersComponent.builder()
                ...
                .add(
                        ...
                        new EntityAttributeModifier(Identifier.ofVanilla("base_entity_interaction_range"), 0.75f, EntityAttributeModifier.Operation.ADD_VALUE),
                        AttributeModifierSlot.MAINHAND
                )
                .build();
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        int charges = stack.getOrDefault(ModDataComponents.DASH_CHARGES, 3);
    ...
    public static void triggerShockwave(ServerPlayerEntity player, float intensity) {
        ...
        double radius = 10.0;
        float damage = 2.0f + (intensity * 0.15f);
    ...
    public int getItemBarStep(ItemStack stack) {
        return Math.round((float) stack.getOrDefault(ModDataComponents.DASH_CHARGES, 3) * 13.0f / 3.0f);
    }
